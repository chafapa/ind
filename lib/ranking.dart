...
class _LeaderboardPageState extends State<LeaderboardPage> {
  ...
  // Scroll listener to check if we're at the bottom
          ...
          Expanded(
            child: Stack(
              children: [
                                  ...
                                  style: TextStyle(
                                    ...
                                    color: restaurant['isYou'] == true 
                                        ...
                                        : restaurant['ranking'] <= 3 
                                            ? _getRankColor(restaurant['ranking']) 
                                            : Colors.black87,
                                  ),
                                ),
                              ),
                              ...
                              Expanded(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    color: restaurant['isYou'] == true ? Colors.white : Colors.black87,
                                  ),
                                ),
                              ),
                ...
                // Podium that shows up when scrolled to bottom
                if (_showPodium)
                  Positioned(
                    bottom: 0,
                    left: 0,
    ...
    return InkWell(
      ...
      child: Column(
        children: [
          ...
          // Underline instead of circular bubble
          if (isSelected)
            Container(
              height: 3,
              width: 60,
